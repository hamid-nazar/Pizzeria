      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center relative">
          ...
          <div className="grow">
            ...
            />
             {addressStatus === "error" && <p className="text-xs text-red-700 bg-red-100 rounded-md mt-2 p-2">{errorAddress}</p>}
          </div>
      {!position.latitude && !position.longitud &&          
      //  sm:right-[1px] sm:top-[5px]
...
export async function action({ request }) {
  ...
  if (!isValidPhone(order.phone)) {
    errors.phone =
      "please give use your correct phone nummber. We might need it contact you.";
  }
